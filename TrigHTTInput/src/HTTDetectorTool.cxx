...
static const InterfaceID IID_HTTDetectorTool("HTTDetectorTool", 1, 0);
const InterfaceID& HTTDetectorTool::interfaceID( )
{ return IID_HTTDetectorTool; }
...
{
  declareInterface<HTTDetectorTool>(this);// needed for rel20
...
StatusCode HTTDetectorTool::initialize(){
  ATH_MSG_INFO ("HTTDetectorTool::initialize()" );
...
StatusCode HTTDetectorTool::finalize(){
...
void HTTDetectorTool::dumpGlobalToLocalModuleMap() {
   ...
   */
  list<HTTHit> CompleteIDModuleList;
