//--------------------------------------------------------------------------------
// Auto generated by DataFormat.py 
// Create Date: 02-10-21 (12:52) 
//--------------------------------------------------------------------------------

#ifndef DATAFORMAT_C
#define DATAFORMAT_C

static const unsigned long int  WORD_LENGTH                    =  0x40;
...
union VERSION_FIELD {
 ...
 static int getNBits() { return 32;} 
  ...
  unsigned int getFullWord() const { return fullword;} 

  // bit descriptors
  const static unsigned int MAJOR_bits = 8;
  const static unsigned int MAJOR_msb = 31;
  const static unsigned int MAJOR_lsb = 24;
  void setMAJOR(unsigned int val) {
      if (val > (1UL<<MAJOR_bits)){ throw("VERSION_FIELD setMAJOR value out of range");}
      fields.MAJOR = val;
  }
  ...
  const static unsigned int MINOR_bits = 8;
  const static unsigned int MINOR_msb = 23;
  const static unsigned int MINOR_lsb = 16;
  void setMINOR(unsigned int val) {
      if (val > (1UL<<MINOR_bits)){ throw("VERSION_FIELD setMINOR value out of range");}
      fields.MINOR = val;
  }
  ...
  const static unsigned int PATCH_bits = 16;
  const static unsigned int PATCH_msb = 15;
  const static unsigned int PATCH_lsb = 0;
  void setPATCH(unsigned int val) {
      if (val > (1UL<<PATCH_bits)){ throw("VERSION_FIELD setPATCH value out of range");}
      fields.PATCH = val;
  }
...
static const unsigned long int  VERSION                        =  0x3040005;

//--------------------------------------------------------------------------------
// MetaWord word description
//--------------------------------------------------------------------------------
union MetaWord {

 static int getNBits() { return 65;} 

  struct  { 
    unsigned long long int W : 64;
    unsigned long long int M : 1;
  } fields;

  // access full word
  unsigned long long int fullword;
  unsigned long long int getFullWord() const { return fullword;} 

  // bit descriptors
  const static unsigned long long int M_bits = 1;
  const static unsigned long long int M_msb = 64;
  const static unsigned long long int M_lsb = 64;
  void setM(unsigned long long int val) {
      if (val > (1UL<<M_bits)){ throw("MetaWord setM value out of range");}
      fields.M = val;
  }
  ...
  const static unsigned long long int W_bits = 64;
  const static unsigned long long int W_msb = 63;
  const static unsigned long long int W_lsb = 0;
  void setW(unsigned long long int val) {
      fields.W = val;
  }
  unsigned long long int getW() {
      return fields.W;
  }
...
union GenMetaData {
 ...
 static int getNBits() { return 64;} 
  ...
  unsigned long int getFullWord() const { return fullword;} 
...
union EVT_HDR_W1 {
 ...
 static int getNBits() { return 64;} 
  ...
  struct  { 
    ...
    unsigned long int SPARE : 6;
    unsigned long int ISGHIT : 1;
  ...
  const static unsigned long int ISGHIT_bits = 1;
  const static unsigned long int ISGHIT_msb = 46;
  const static unsigned long int ISGHIT_lsb = 46;
  void setISGHIT(unsigned long int val) {
      if (val > (1UL<<ISGHIT_bits)){ throw("EVT_HDR_W1 setISGHIT value out of range");}
      fields.ISGHIT = val;
  }
  unsigned long int getISGHIT() {
      return fields.ISGHIT;
  }

  const static unsigned long int SPARE_bits = 6;
  const static unsigned long int SPARE_msb = 45;
...
//--------------------------------------------------------------------------------
struct EVT_HDR {
  EVT_HDR_W1 EVT_HDR_W1_t;
  EVT_HDR_W2 EVT_HDR_W2_t;
  EVT_HDR_W3 EVT_HDR_W3_t;
  EVT_HDR_W4 EVT_HDR_W4_t;
  EVT_HDR_W5 EVT_HDR_W5_t;
  EVT_HDR_W6 EVT_HDR_W6_t;
};
...
//--------------------------------------------------------------------------------
struct EVT_FTR {
  EVT_FTR_W1 EVT_FTR_W1_t;
  EVT_FTR_W2 EVT_FTR_W2_t;
  EVT_FTR_W3 EVT_FTR_W3_t;
};
...
static const unsigned long int  PIXEL_RAW_BITS                 =  0x40;
...
union HCC_HDR {
 ...
 static int getNBits() { return 16;} 
  ...
  unsigned short int getFullWord() const { return fullword;} 
...
static const unsigned long int  HCC_LAST_CLUSTER               =  0x6fed;
...
static const unsigned long int  DETMAP_PIXEL                   =  0x0;

static const unsigned long int  DETMAP_STRIP                   =  0x1;
...
union GHIT {
 ...
 static int getNBits() { return 32;} 
  ...
  // bit descriptors
  const static unsigned int LYR_bits = 4;
  const static unsigned int LYR_msb = 31;
  const static unsigned int LYR_lsb = 28;
  void setLYR(unsigned int val) {
      if (val > (1UL<<LYR_bits)){ throw("GHIT setLYR value out of range");}
      fields.LYR = val;
  }
  unsigned int getLYR() {
      return fields.LYR;
  ...
  const static unsigned int RAD_bits = 12;
  const static unsigned int RAD_msb = 27;
  const static unsigned int RAD_lsb = 16;
  void setRAD(unsigned int val) {
      if (val > (1UL<<RAD_bits)){ throw("GHIT setRAD value out of range");}
      fields.RAD = val;
  }
  unsigned int getRAD() {
      return fields.RAD;
  ...
  const static unsigned int PHI_bits = 16;
  const static unsigned int PHI_msb = 15;
  const static unsigned int PHI_lsb = 0;
  void setPHI(unsigned int val) {
      if (val > (1UL<<PHI_bits)){ throw("GHIT setPHI value out of range");}
      fields.PHI = val;
  }
  unsigned int getPHI() {
      return fields.PHI;
...
union GHITZ {
 ...
 static int getNBits() { return 64;} 
  ...
  struct  { 
    unsigned long int SPARE : 16;
    unsigned long int Z : 16;
    unsigned long int PHI : 16;
    unsigned long int RAD : 12;
    unsigned long int LYR : 4;
  } fields;
  ...
  // bit descriptors
  const static unsigned long int LYR_bits = 4;
  const static unsigned long int LYR_msb = 63;
  const static unsigned long int LYR_lsb = 60;
  void setLYR(unsigned long int val) {
      if (val > (1UL<<LYR_bits)){ throw("GHITZ setLYR value out of range");}
      fields.LYR = val;
  }
  unsigned long int getLYR() {
      return fields.LYR;
  }

  const static unsigned long int RAD_bits = 12;
  const static unsigned long int RAD_msb = 59;
  const static unsigned long int RAD_lsb = 48;
  void setRAD(unsigned long int val) {
      if (val > (1UL<<RAD_bits)){ throw("GHITZ setRAD value out of range");}
      fields.RAD = val;
  }
  unsigned long int getRAD() {
      return fields.RAD;
  }

  const static unsigned long int PHI_bits = 16;
  const static unsigned long int PHI_msb = 47;
  const static unsigned long int PHI_lsb = 32;
  void setPHI(unsigned long int val) {
      if (val > (1UL<<PHI_bits)){ throw("GHITZ setPHI value out of range");}
      fields.PHI = val;
  }
  unsigned long int getPHI() {
      return fields.PHI;
  ...
  const static unsigned long int Z_bits = 16;
  const static unsigned long int Z_msb = 31;
  const static unsigned long int Z_lsb = 16;
  void setZ(unsigned long int val) {
      if (val > (1UL<<Z_bits)){ throw("GHITZ setZ value out of range");}
      fields.Z = val;
  }
  unsigned long int getZ() {
      return fields.Z;
  }

  const static unsigned long int SPARE_bits = 16;
  const static unsigned long int SPARE_msb = 15;
  const static unsigned long int SPARE_lsb = 0;
  void setSPARE(unsigned long int val) {
      if (val > (1UL<<SPARE_bits)){ throw("GHITZ setSPARE value out of range");}
      fields.SPARE = val;
  }
  unsigned long int getSPARE() {
      return fields.SPARE;
