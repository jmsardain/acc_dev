...
union EVT_HDR_W1 {
  ...
  const static unsigned long int DATA_TYPE_MODULES = 0x2;
...
union STRIP_CLUSTER {
  ...
  const static unsigned short int LEN_lsb = 11;
  ...
  const static unsigned short int IDX_msb = 10;
...
union TRACK_W1 {
  ...
  const static unsigned long int FLAG_msb = 63;
  const static unsigned long int FLAG_lsb = 56;
  const static unsigned long int FLAG_FLAG = 0x77;
  void setFLAG(unsigned long int val) {
  ...
  const static unsigned long int SPARE_bits = 52;
  const static unsigned long int SPARE_msb = 51;
  const static unsigned long int SPARE_lsb = 0;
  void setSPARE(unsigned long int val) {
...
union TRACK_STRIP_CLUSTER {
  ...
  const static unsigned int IDX_lsb = 4;
  ...
  const static unsigned int LEN_msb = 3;
