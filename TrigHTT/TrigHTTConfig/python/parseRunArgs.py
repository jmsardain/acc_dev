...
_HTTBanksArgs = [
    ...
    ("WCmax", trfArgClasses.argInt, "Maximum allowed wildcards in a pattern (default: 2)"),
    ("WCplanes", trfArgClasses.argIntList, "Specify specific layers that wildcards are allowed (default: all true)"),
    ("seed", trfArgClasses.argInt, "Primary seed of the RNG"),
    ("seed2", trfArgClasses.argInt, "Secondary seed of the RNG"),
]
...
_HTTAlgorithmsArgs = [
    ...
    ("realAndRandomHits",trfArgClasses.argBool, "Use real and random hits together"),
    ...
    ("houghplotJMS", trfArgClasses.argBool, "Use Hough transform for road finding"),
...
_HTTLRTArgs = [
    ...
    ('triplet', trfArgClasses.argBool, "standard doublet or doublet+3rd hit information"),
    ("jmsseed", trfArgClasses.argInt, "Primary seed of the RNG"),
    ("jmsseed2", trfArgClasses.argInt, "Secondary seed of the RNG"),
