...
empty_tag = {
    ...
    'connection':   '', # Sector connection filepath
...
HTTMapTags = {
        'EF_TaskForce_dev23' : {
            ...
            'ssmap':        'htt_configuration/ss_files/{regionName}_ATLAS-P2-ITK-22-02-00.ss',
            ...
            'connection':   'htt_configuration/map_files/connectionFile_geo22.patt',
