...
//For the new non-pointer hell version of clusters
...
//#pragma link C++ class HTTPattern+;
//#pragma link C++ class std::vector<HTTPattern>+;
//#pragma link C++ class std::vector< std::map<int,HTTPattern> >+;

#pragma link C++ class HTTCoord+;
