...
static const InterfaceID IID_HTTLLPRoadFilterTool("HTTLLPRoadFilterTool", 1, 0);
const InterfaceID& HTTLLPRoadFilterTool::interfaceID()
{ return IID_HTTLLPRoadFilterTool; }


HTTLLPRoadFilterTool::HTTLLPRoadFilterTool (const std::string& algname, const std::string& name, const IInterface* ifc) 
    : AthAlgTool(algname, name, ifc) {}

StatusCode HTTLLPRoadFilterTool::initialize() { 
    return StatusCode::SUCCESS;
}

StatusCode HTTLLPRoadFilterTool::finalize() {
    return StatusCode::SUCCESS;
}
